        ...
        <div class="container-fluid col-md-10 col-md-offset-1">
            ...
            <div class="card">
                <div class="card-header d-flex p-0">
                    <h3 class="card-title p-3">Usuarios</h3>
                    <ul class="nav nav-pills ml-auto p-2">
                        <li class="nav-item"><a class="nav-link active" href="#tab_1" data-toggle="tab">Nuevo Usuario</a></li>
                        <li class="nav-item"><a class="nav-link" href="#tab_2" data-toggle="tab">Usuarios Guardados</a></li>
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-md-6">
                                                ...
                                                <input type="text" class="form-control" id="usuario" placeholder="Introducir usuario.">
                                            </div>
                                            <div class="col-md-6">
                                                <label for="contraseña">Contraseña</label>
                                                <input type="password" class="form-control" id="contraseña" placeholder="Introducir contraseña.">
                                            </div>
                                            <div class="col-md-6">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <input type="email" class="form-control" id="email" placeholder="Introducir e-mail.">
                                            </div>
                            ...
                            <section class="content">
                                <div class="row">
                                    <div class="col-12">
                                        ...
                                        <div class="card">
                                            <div class="card-header">
                                                <h3 class="card-title">Usuarios Guardados</h3>
                                            </div>
                                            <!-- /.card-header -->
                                            <div class="card-body">
